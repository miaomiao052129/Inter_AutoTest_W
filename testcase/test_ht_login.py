...
def test_ht_ProductQuery():
    ...
    cookies = {"SESSION": "YWJkMGIzNzctNzljMC00ZDE2LTgwMzEtZGQ5NThmZmIyOTVj"}  #session会过期,需要登录再次获取一下session
...
def test_ht_xptjgl_xz():
    ...
    cookies={"SESSION":"YWJkMGIzNzctNzljMC00ZDE2LTgwMzEtZGQ5NThmZmIyOTVj"}
